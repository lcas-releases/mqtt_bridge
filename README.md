## mqtt_bridge_lcas (melodic) - 1.4.3-1

The packages in the `mqtt_bridge_lcas` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -y --no-web -t melodic -r melodic mqtt_bridge_lcas` on `Mon, 01 Aug 2022 14:30:31 -0000`
...
## mqtt_bridge_lcas (melodic) - 1.4.2-1
